  ...
  return (
    <div className="flex flex-col gap-6 p-6 bg-gray-50 rounded-lg">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-800">Our Impact in Numbers</h1>
        <p className="text-gray-600 mt-2">Total funds raised: ${totalFunds.toLocaleString()}</p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Funds Raised Chart */}
        <Card className="p-4 shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">Funds Raised</h2>
        ...
        <Card className="p-4 shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">Fund Allocation</h2>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie
                data={pieData}
        ...
        <Card className="p-4 shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">Volunteer Growth</h2>
          <p className="text-gray-600 mb-2">Current volunteers: {totalVolunteers}</p>
          <ResponsiveContainer width="100%" height={250}>
