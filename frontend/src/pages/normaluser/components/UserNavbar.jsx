...
import { Bell, Search, Menu, X, Heart, ChevronDown, Globe, Users, BarChart3, Leaf, LogOut, Settings, History, User } from "lucide-react";
      ...
      <nav className={`relative flex items-center justify-between px-6 py-4 w-full transition-all duration-300 ${
        ...
        <div className="flex items-center space-x-2 cursor-pointer">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2L4 6V18L12 22L20 18V6L12 2Z" fill="#8df1e2" stroke="#166856" strokeWidth="1.5" />
            <path d="M12 6V16M12 16L16 14M12 16L8 14" stroke="#0d3320" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
          <span className="text-xl font-bold text-[#166856]">Eco<span className="text-[#0d3320]">Impact</span></span>
        </div>
            ...
            {navItems.map((item, index) => (
              <div key={index} className="relative group">
                <div 
                  ...
                  onClick={(e) => item.hasDropdown && toggleDropdown(index, e)}
                >
                  <span className="hover:text-[#166856] transition-all">{item.name}</span>
                  {item.hasDropdown && (
                    <ChevronDown 
                      size={16} 
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative" onClick={toggleNotifications}>
              <div className="cursor-pointer p-2 hover:bg-[#8df1e2]/20 rounded-full transition-all">
                <Bell className="text-[#0d3320] hover:text-[#166856]" size={20} />
              ...
              {notificationsOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg z-10 border border-[#8df1e2]/50 animate-in fade-in-80 zoom-in-95">
                  <div className="flex items-center justify-between p-3 border-b border-[#8df1e2]/30">
                    <h3 className="font-medium text-[#0d3320]">Notifications</h3>
                  ...
                  <div className="max-h-60 overflow-y-auto">
                    <div className="p-3 border-b border-[#8df1e2]/30 hover:bg-[#8df1e2]/10 transition-colors cursor-pointer">
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-sm font-medium text-[#0d3320]">New reforestation project launched</p>
                          <p className="text-xs text-[#166856]/70 mt-1">15 minutes ago</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-3 hover:bg-[#8df1e2]/10 transition-colors cursor-pointer">
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-sm font-medium text-[#0d3320]">Your donation has been processed</p>
                          <p className="text-xs text-[#166856]/70 mt-1">Yesterday</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeDropdown === 'profile' && (
                <div className="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-sm rounded-md shadow-lg z-10 py-1 border border-[#8df1e2]/50 animate-in fade-in-80 zoom-in-95">
                  <div className="px-4 py-3 border-b border-[#8df1e2]/30">
                    <p className="text-sm font-medium text-[#0d3320]">Sarah Johnson</p>
                    <p className="text-xs text-[#166856]/70 mt-1">sarah.j@example.com</p>
                  </div>
                  
                  <a href="#" className="flex items-center px-4 py-3 text-sm text-[#0d3320] hover:bg-[#8df1e2]/10 hover:text-[#166856] transition-colors">
        ...
        <div className="lg:hidden flex items-center space-x-4">
          ...
          <div className="relative" onClick={toggleNotifications}>
            <div className="cursor-pointer p-2 hover:bg-[#8df1e2]/20 rounded-full transition-all">
              ...
              <span className="absolute top-0 right-0 bg-red-500 rounded-full w-3 h-3 flex items-center justify-center text-white text-xs">2</span>
            </div>
          </div>
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-sm shadow-lg max-h-screen overflow-y-auto animate-in slide-in-from-top-5">
          <div className="px-4 pt-4 pb-6">
                ...
                <div key={index} className="py-2">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      {item.icon}
                      <span className="font-medium text-[#0d3320]">{item.name}</span>
                    </div>
                    {item.hasDropdown && (
                      <ChevronDown 
                        size={16} 
            ...
            <div className="mt-6 pt-4 border-t border-[#8df1e2]/30 space-y-1">
              <h3 className="text-sm font-medium text-[#0d3320] px-2 mb-2">Profile</h3>
              
              <a href="#" className="flex items-center px-2 py-3 rounded-md hover:bg-[#8df1e2]/10 text-sm text-[#0d3320]">
              ...
              <div className="pt-4 mt-4 border-t border-[#8df1e2]/30">
                <a href="#" className="flex items-center px-2 py-3 rounded-md hover:bg-red-50 text-sm text-red-600">
                  <LogOut size={16} className="mr-2" />
                  Logout
                </a>
              </div>
