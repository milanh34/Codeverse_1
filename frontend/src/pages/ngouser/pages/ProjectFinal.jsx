...
const ProjectFinal = () => {
  ...
  const project = {
    ...
    description:
      "Join us for a massive tree plantation initiative aimed at creating a greener future for our community. This project focuses on urban areas lacking green spaces.",
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8">
        <div className="flex justify-between items-end">
          ...
          <div className="text-white text-right">
            ...
            <p className="text-sm">
              raised of ₹{project.targetFunding.toLocaleString()}
            </p>
          </div>
        </div>
      </div>
          ...
          {!isFullyFunded && (
            <div className="space-y-3 pt-4 border-t border-[#166856]/10">
              ...
              <p className="text-sm text-[#166856]/80">
                Remaining: ₹
                {(project.targetFunding - currentFunding).toLocaleString()}
              </p>
            </div>
          )}
        </div>
